                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            <div class="d-flex justify-content-center py-4">
                                <a href="{{ url('') }}" class="logo d-flex align-items-center w-auto">
                                    <img src="{{ asset('backend_assets/img/E-vahan-logo.png') }}" alt="" />
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" action="" method="POST">
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">
                                                Don't have account?
                                                <a href="{{ url('seo-register') }}">Create an account</a>
                                            </p>
                                            <p class="small mb-1 mt-3">
                                                <a href="{{ url('seo-forgot-password') }}">I Forgot My Password</a>
                                            </p>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="credits">
                                Designed by <a href="/">Kartik Sharma</a>
                            </div>
                        </div>
                    </div>
                </div>
